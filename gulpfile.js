...
const html = () => {
    return gulp.src(path.source.html)
        ...
        .pipe(gulpIf(isProd, versionNumber({
            'value': '%DT%',
            'append': {
                'key': '_v',
                'cover': 0,
...
const js = () => {
    return gulp.src(path.source.js, { sourcemaps: !isProd })
		.pipe(webpack({
...
export const start = gulp.series(clean, html, scss, js, fonts, images, gulp.parallel(watchFiles, webServer));
